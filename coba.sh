...
# mendeklarasikan dua buah array
declare -a pilihan
declare -A menus

# memasukan nilai array menus 2d 
menus[1,0]=1
menus[1,1]=10
...
# mengambil nilai panjang array lalu dibagi 
#3 untuk mendapat nilai yang sesuai dengan jumlah produk
...
do
        ...
        # masukan pilihan user dalam array pilihan
        if [ $pil -ne 19 ];
        then
        pilihan+=($pil)   
        else
...
# melakukan looping untuk menjumlahkan pesanan user
i=0
...
do
        ...
        # memasukan nilai setiap menu ke nilai sementara untuk kalkulasi
        nilai_sementara=${menus[${pilihan[i]},1]}
        # melakukan operasi aritmatika dengan nilai setiap menu
        total=$(expr $total + $nilai_sementara)

done

# menampilkan total yang telah didapat
echo ""
